...
// calulate monthly value
 ...
 //firstly years are converted into months.
 //secondly  rate is converted into monthly interest rate 
    let monthlyRate = Math.pow(1+ ( (rate / 100) / 12 ) , (years * 12) );
    let monthlyValue =  investment * monthlyRate;
// display results
